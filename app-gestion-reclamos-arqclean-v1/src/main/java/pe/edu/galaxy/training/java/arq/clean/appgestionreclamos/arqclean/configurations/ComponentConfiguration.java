 ...
 * 
 * @Configuration public class ComponentConfiguration implements
 * CommandLineRunner {
 * 
 * 
 ...
 * 
 * proveedorRespository.save( ProveedorEntity.builder()
 * .id(1L).razonSocial("GALAXY TRAINING PERU") .correo("contacto@galaxy.edu.pe")
 * .telefono("+51 950 4506") .estado("1") .build());
 * 
 * proveedorRespository.findAll().forEach((city) -> { log.info("{}", city); });
 * 
 * }
 * 
 * }
